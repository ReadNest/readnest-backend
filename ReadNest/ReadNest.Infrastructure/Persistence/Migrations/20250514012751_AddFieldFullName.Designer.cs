...
namespace ReadNest.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250514012751_AddFieldFullName")]
            ...
            modelBuilder.Entity("ReadNest.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9d5ac316-0291-4983-a765-4ef7d9e64bf6"),
                            CreatedAt = new DateTime(2025, 5, 14, 1, 27, 50, 636, DateTimeKind.Utc).AddTicks(6087),
                            IsDeleted = false,
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 5, 14, 1, 27, 50, 636, DateTimeKind.Utc).AddTicks(6093)
                        },
                        new
                        {
                            Id = new Guid("0c2d0b97-0520-4af3-ab0a-211295f8192a"),
                            CreatedAt = new DateTime(2025, 5, 14, 1, 27, 50, 636, DateTimeKind.Utc).AddTicks(6094),
                            IsDeleted = false,
                            RoleName = "User",
                            UpdatedAt = new DateTime(2025, 5, 14, 1, 27, 50, 636, DateTimeKind.Utc).AddTicks(6095)
                        });
                });
