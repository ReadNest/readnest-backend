...
namespace ReadNest.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250724021247_AddTableUserSearchHistory")]
    partial class AddTableUserSearchHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReadNest.Domain.Entities.Feature", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ReadNest.Domain.Entities.Package", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ReadNest.Domain.Entities.PackageFeature", b =>
                {
                    ...
                    b.ToTable("package_features", (string)null);
                });
            ...
            modelBuilder.Entity("ReadNest.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("65208406-ad8d-432f-a4cc-28ea95ab2e26"),
                            CreatedAt = new DateTime(2025, 7, 24, 2, 12, 47, 336, DateTimeKind.Utc).AddTicks(800),
                            IsDeleted = false,
                            RoleName = "Admin",
                            UpdatedAt = new DateTime(2025, 7, 24, 2, 12, 47, 336, DateTimeKind.Utc).AddTicks(803)
                        },
                        new
                        {
                            Id = new Guid("cb19482f-5d37-4da4-b352-d645bbd0f850"),
                            CreatedAt = new DateTime(2025, 7, 24, 2, 12, 47, 336, DateTimeKind.Utc).AddTicks(806),
                            IsDeleted = false,
                            RoleName = "User",
                            UpdatedAt = new DateTime(2025, 7, 24, 2, 12, 47, 336, DateTimeKind.Utc).AddTicks(806)
                        });
                });
            ...
            modelBuilder.Entity("ReadNest.Domain.Entities.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ReadNest.Domain.Entities.UserSearchHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("user_search_histories", (string)null);
                });

            modelBuilder.Entity("ReadNest.Domain.Entities.UserSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ReadNest.Domain.Entities.PackageFeature", b =>
                {
                    b.HasOne("ReadNest.Domain.Entities.Feature", "Feature")
                        .WithMany("PackageFeatures")
                        .HasForeignKey("FeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ReadNest.Domain.Entities.Package", "Package")
                        .WithMany("PackageFeatures")
